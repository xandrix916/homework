...
public class LogStrings {
    ...
    public static final String turnNumber = "TURN #%d\n";
    ...
    public static final String outOfAttempts = "FAIL: NO ATTEMPTS LEFT\n";

    public static final String winOfGame = "WIN: WORD IS FULLY OPENED\n";
