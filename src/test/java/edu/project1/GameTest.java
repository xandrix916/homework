...
class GameTest {
    ...
    void testRed() {
        ...
        Assertions.assertEquals(response.toString(), Responses.RESPONSE_1);
    }
    ...
    void testDepth() {
        ...
        GameJournal response = game.run(turns);
        Assertions.assertEquals(response.toString(), Responses.RESPONSE_2);
    }
    ...
    void testHangover() {
        ...
        GameJournal response = game.run(turns);
        Assertions.assertEquals(response.toString(), Responses.RESPONSE_3);
    }
    ...
    void rageTest() {
        ...
        GameJournal response = game.run(turns);
        Assertions.assertEquals(response.toString(), Responses.RESPONSE_4);
    }
    ...
    void dumbAndDumber() {
        ...
        GameJournal response = game.run(turns);
        Assertions.assertEquals(response.toString(), Responses.RESPONSE_5);
    }
    ...
    void brokenKeyboard() {
        ...
        GameJournal response = game.run(turns);
        Assertions.assertEquals(response.toString(), Responses.RESPONSE_6);
    }
    ...
    void whySoManyLetters() {
        ...
        GameJournal response = game.run(turns);
        Assertions.assertEquals(response.toString(), Responses.RESPONSE_7);
    }
}
